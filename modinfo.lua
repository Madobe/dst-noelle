...
description = "A maid who faithfully serves the Knights of Favonius. She dreams of joining their ranks someday.\n\n[Perks]\nArmored Rose: Innate 30% physical damage reduction. \n\nGeo Vision: Starts with a protective trinket. Right-click to cast a 200 HP shield that lasts 12s, 24s cooldown. While the shield is up, 55% chance to heal 5% of own health on attacking. Every 4th attack she inflicts while the shield is on cooldown will reduce it by 1s. While the shield is up, Noelle is protected from the special effects of enemy attacks."
author = "Sai"
